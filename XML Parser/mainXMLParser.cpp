...
int main () {
	...
	inputString="<?xml version=1.0 encoding=UTF-8?><note><to>Tove</to><from name=test, joe=teddy >Jani</from><heading>Reminder</heading><note/><body>Don't forget me this weekend!</body></note>";
	cout << inputString;
